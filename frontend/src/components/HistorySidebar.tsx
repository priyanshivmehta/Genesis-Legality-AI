  ...
  return (
    <>
      <button
        ...
        className="fixed top-4 left-4 z-40 flex items-center space-x-2 px-4 py-2 bg-white border border-gray-200 rounded-md shadow-sm hover:shadow-md transition-all text-gray-700 hover:text-gray-900"
      >
